...
| ID    | Задача           | Описание                                | Старт      | Дедлайн    | Статус      |
| ----- | ---------------- | --------------------------------------- | ---------- | ---------- | ----------- |
| QA-01 | Unit/Integration | Vitest + RTL: ядро/редьюсеры/компоненты | 2025-08-21 | 2025-08-28 | in_progress |
...
| POST-01 | Post            | Мониторинг                                    | 2025-08-30 | 2025-09-01 | pending | Size-limit/Bundle analyzer, отчёт                           |
